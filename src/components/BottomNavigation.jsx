    ...
    return (
      <motion.button
        ...
        className={clsx(
          ...
          "min-h-[64px] px-4 py-2",
          "transition-all duration-300 ease-out-expo",
          "focus:outline-none",
          {
            "scale-110": active && item.isCenter,
      ...
      >
        ...
        {item.isCenter && (
          <motion.div
            className={clsx(
              ...
              "bg-gradient-to-t from-accent-blue/20 to-accent-purple/20",
        ...
        <motion.span
          className={clsx(
            ...
            {
              "text-xs": !item.isCenter,
              "text-sm font-semibold": item.isCenter && active,
            },
          )}
          animate={{
