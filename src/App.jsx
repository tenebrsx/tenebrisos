...
const AppLayout = () => {
  ...
  const shouldShowOnboarding = !hasCompletedOnboarding && location.pathname !== '/onboarding';
      ...
      <div className="relative z-10 min-h-screen pt-20">
        <PageTransition locationKey={location.pathname}>
          <Routes key={location.pathname}>
            ...
            <Route path="/" element={shouldShowOnboarding ? <Onboarding /> : <Home />} />
            <Route path="/activities" element={shouldShowOnboarding ? <Onboarding /> : <Activities />} />
            <Route path="/schedule" element={shouldShowOnboarding ? <Onboarding /> : <Schedule />} />
            <Route path="/schedule/generate" element={shouldShowOnboarding ? <Onboarding /> : <ScheduleGeneration />} />
            <Route path="/things-to-do" element={shouldShowOnboarding ? <Onboarding /> : <ThingsToDo />} />
            <Route path="/notes" element={shouldShowOnboarding ? <Onboarding /> : <Notes />} />
            <Route path="/todos" element={shouldShowOnboarding ? <Onboarding /> : <Todos />} />
            <Route path="/mindmap" element={shouldShowOnboarding ? <Onboarding /> : <MindmapDashboard />} />
            <Route path="/mindmap/:id" element={shouldShowOnboarding ? <Onboarding /> : <MindmapEditor />} />
            <Route path="/settings" element={shouldShowOnboarding ? <Onboarding /> : <Settings />} />
            <Route path="/profile" element={shouldShowOnboarding ? <Onboarding /> : <Profile />} />
            <Route path="/login" element={<Login />} />
            <Route path="/statistics" element={shouldShowOnboarding ? <Onboarding /> : <Statistics />} />
          </Routes>
        </PageTransition>
      </div>
