      ...
      case "general":
        return (
          <div className="space-y-6">
            ...
            <SettingItem
              label="Visual Theme"
              description="Choose your preferred visual style - Modern, Minimalist Monochrome, or Classic retro themes"
            >
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <div className="w-8 h-8 rounded-lg bg-gray-200 border border-gray-300 flex items-center justify-center">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <motion.button
                      onClick={() => changeTheme("monochrome-dark")}
                      className={`p-4 rounded-xl border-2 transition-all text-left ${
                        getActiveTheme() === "monochrome-dark"
                          ? "border-white bg-white/10"
                          : "border-dark-border bg-dark-surface hover:border-white/50"
                      }`}
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      <div className="flex items-center space-x-3">
                        <div className="w-8 h-8 rounded-lg bg-black border border-white flex items-center justify-center">
                    ...
                    <motion.button
                      onClick={() => changeTheme("monochrome-light")}
                      className={`p-4 rounded-xl border-2 transition-all text-left ${
                        getActiveTheme() === "monochrome-light"
                          ? "border-white bg-white/10"
                          : "border-dark-border bg-dark-surface hover:border-white/50"
                      }`}
                      whileHover={{ scale: 1.02 }}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <div className="w-8 h-8 rounded bg-blue-500 border border-gray-400 flex items-center justify-center">
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <div className="w-8 h-8 rounded bg-gray-800 border border-blue-500 flex items-center justify-center">
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <div className="w-8 h-8 rounded-lg bg-gray-350 border border-gray-500 flex items-center justify-center">
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <div className="w-8 h-8 rounded-lg bg-gray-700 border border-gray-500 flex items-center justify-center">
                ...
                {(getActiveTheme().includes("retro") ||
                  getActiveTheme().includes("macos9")) && (
                  <div className="p-4 bg-blue-150 rounded-lg border-2 border-blue-400">
