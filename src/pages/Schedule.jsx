      ...
      >
        ...
        >
          <h1 className="text-3xl font-display font-bold flex items-center justify-center space-x-3">
            ...
            <span className="text-gradient-blue">AI Schedule</span>
          </h1>
                    ...
                    {totalHours > 0 && (
                      <div
                        className={`absolute inset-0 bg-gradient-to-br transition-opacity duration-300 ${
                          intensity > 0.7
                            ? "from-accent-red/10 to-accent-orange/10 opacity-70"
                            : intensity > 0.4
                              ? "from-accent-blue/10 to-accent-purple/10 opacity-50"
                              : "from-accent-green/10 to-accent-blue/10 opacity-30"
                        }`}
                      />
                    )}
                  ...
                  >
                    {[...Array(7)].map((_, i) => {
                      ...
                      return (
                        <div
                          key={i}
                          className={`w-1.5 rounded-full bg-gradient-to-t cursor-pointer transition-all duration-200 hover:w-2 ${
                            intensity > 0.7
                              ...
                              : intensity > 0.4
                                ...
                                : intensity > 0.1
                                  ...
                                  : "from-dark-border to-dark-border"
                          }`}
