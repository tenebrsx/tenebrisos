        ...
        >
          <div className="text-left space-y-2">
            <h1 className="text-3xl font-display font-bold flex items-center space-x-3">
              ...
              <span className="text-gradient-blue">Activities</span>
            </h1>
          ...
          {filteredActivities.length === 0 ? (
            <motion.div className="card text-center py-12">
              <motion.div
                ...
                className="w-20 h-20 mx-auto mb-6 rounded-full bg-gradient-to-r from-accent-blue/20 to-accent-purple/20 flex items-center justify-center"
              >
